...
interface ProductLikeHeaderProps {
	totalCount?: number;
	username?: string;
	onPlay?: () => void;
}
 ...
 * - 전체 재생 및 셔플 기능 제공
 */
export const ProductLikeHeader = memo(({ totalCount = 32, username = "홍길동", onPlay }: ProductLikeHeaderProps) => {
...
ProductLikeHeader.displayName = "ProductLikeHeader";
