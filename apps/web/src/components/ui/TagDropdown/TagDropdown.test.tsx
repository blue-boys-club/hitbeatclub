...
describe("TagDropdown", () => {
  ...
  it("renders with custom trigger text", () => {
    render(<TagDropdown trigger="Custom" options={mockOptions} />);
  ...
  it("handles long text in trigger and options", () => {
    ...
    render(<TagDropdown trigger={longTrigger} options={longOptions} />);
  ...
  it("closes dropdown when clicking outside", () => {
    const onOpenChange = vi.fn();
    render(<TagDropdown options={mockOptions} onOpenChange={onOpenChange} />);
  ...
  it("opens dropdown on children trigger click", () => {
    const onOpenChange = vi.fn();
    render(
      <TagDropdown options={mockOptions} onOpenChange={onOpenChange}>
        <button>Custom Button</button>
      </TagDropdown>
    );
  ...
  it("renders in open state when defaultOpen is true", () => {
    render(<TagDropdown options={mockOptions} defaultOpen={true} />);
    expect(screen.getByTestId("tag-dropdown-menu")).toBeInTheDocument();
  });
  ...
  it("renders without chevron when showChevron is false", () => {
    render(<TagDropdown options={mockOptions} showChevron={false} />);
