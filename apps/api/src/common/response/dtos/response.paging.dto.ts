...
export class ResponsePagingDto extends PickType(ResponseDto, ["statusCode", "message"] as const) {
	@ApiProperty({
		name: "_metadata",
		required: true,
		nullable: false,
		...
		example: {
			...
			pagination: {
				...
				availableOrderDirection: PAGINATION_DEFAULT_AVAILABLE_ORDER_DIRECTION,
				total: 100,
				totalPage: 5,
			},
			cursor: {
