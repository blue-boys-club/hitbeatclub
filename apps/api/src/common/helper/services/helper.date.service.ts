...
export class HelperDateService implements IHelperDateService {
	...
	diff(dateOne: Date, dateTwoMoreThanDateOne: Date, options?: IHelperDateDiffOptions): number {
	...
	create(date?: string | number | Date, options?: IHelperDateCreateOptions): Date {
	...
	createTimestamp(date?: string | number | Date, options?: IHelperDateCreateOptions): number {
		const mDate = moment(date ?? undefined).tz(this.defTz);
	...
	forwardInSeconds(seconds: number, options?: IHelperDateForwardOptions): Date {
		return moment(options?.fromDate).tz(this.defTz).add(seconds, "seconds").toDate();
	}

	backwardInSeconds(seconds: number, options?: IHelperDateBackwardOptions): Date {
		return moment(options?.fromDate).tz(this.defTz).subtract(seconds, "seconds").toDate();
	}

	forwardInMinutes(minutes: number, options?: IHelperDateForwardOptions): Date {
		return moment(options?.fromDate).tz(this.defTz).add(minutes, "minutes").toDate();
	}

	backwardInMinutes(minutes: number, options?: IHelperDateBackwardOptions): Date {
		return moment(options?.fromDate).tz(this.defTz).subtract(minutes, "minutes").toDate();
	}

	forwardInHours(hours: number, options?: IHelperDateForwardOptions): Date {
		return moment(options?.fromDate).tz(this.defTz).add(hours, "hours").toDate();
	}

	backwardInHours(hours: number, options?: IHelperDateBackwardOptions): Date {
		return moment(options?.fromDate).tz(this.defTz).subtract(hours, "hours").toDate();
	}
	...
	backwardInDays(days: number, options?: IHelperDateBackwardOptions): Date {
		return moment(options?.fromDate).tz(this.defTz).subtract(days, "days").toDate();
	}

	forwardInMonths(months: number, options?: IHelperDateForwardOptions): Date {
		return moment(options?.fromDate).tz(this.defTz).add(months, "months").toDate();
	}

	backwardInMonths(months: number, options?: IHelperDateBackwardOptions): Date {
		return moment(options?.fromDate).tz(this.defTz).subtract(months, "months").toDate();
	}

	forwardInYears(years: number, options?: IHelperDateForwardOptions): Date {
		return moment(options?.fromDate).tz(this.defTz).add(years, "years").toDate();
	}

	backwardInYears(years: number, options?: IHelperDateBackwardOptions): Date {
		return moment(options?.fromDate).tz(this.defTz).subtract(years, "years").toDate();
	}
	...
	setTime(date: Date, { hour, minute, second, millisecond }: IHelperDateSetTimeOptions): Date {
		return moment(date)
			.tz(this.defTz)
			.set({
				hour: hour,
	...
	addTime(date: Date, { hour, minute, second, millisecond }: IHelperDateSetTimeOptions): Date {
		return moment(date)
			.tz(this.defTz)
			.add({
				hour: hour,
	...
	subtractTime(date: Date, { hour, minute, second }: IHelperDateSetTimeOptions): Date {
		return moment(date)
			.tz(this.defTz)
			.subtract({
				hour: hour,
