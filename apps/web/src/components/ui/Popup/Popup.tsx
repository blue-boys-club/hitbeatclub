...
>(({ className, children, ...props }, ref) => (
  <PopupPortal>
    ...
    <DialogPrimitive.Content
      ...
      {...props}
    >
      <div className="relative p-[50px] overflow-y-auto max-h-[80vh] grid gap-[25px]">
        {children}
      </div>
...
const PopupHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col text-center items-center gap-[25px]",
      className
    )}
    {...props}
  />
...
const PopupFooter = ({
  ...
  <div
    className={cn(
      "flex flex-row items-center justify-center gap-[25px]",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn(
      "text-[26px] leading-[32px] tracking-[0.26px] font-medium font-suit",
      className
    )}
    {...props}
  />
