...
const longOptions = [
  {
    label:
      "This is a very long option that should be truncated when necessary and shown fully in dropdown",
    value: "long1",
  },
  {
    label:
      "Another extremely long option text that demonstrates how the dropdown handles overflow",
    value: "long2",
  },
