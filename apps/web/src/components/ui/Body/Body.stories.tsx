...
const meta: Meta = {
	...
	argTypes: {
		as: {
			...
			options: ["div", "span", "p", "article", "section", "main", "aside", "nav", "header", "footer"],
			control: {
				type: "select",
			},
		},
...
export const BodyMediumMixedTag: Story = {
	render: () => (
		<BodyMedium>
			<span className="text-hbc-red">{englishText}</span> <span className="text-hbc-blue">{koreanText}</span>
		</BodyMedium>
	),
};
