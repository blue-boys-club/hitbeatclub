 ...
 * 허용된 HTML Body 태그
 */
export type AllowedBodyElements = NonNullable<VariantProps<typeof baseBodyVariants>["as"]>;
...
export const BaseBody = memo(
	forwardRef<React.ComponentRef<React.ElementType>, BaseBodyProps<AllowedBodyElements>>(
