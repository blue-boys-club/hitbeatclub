...
describe("ArtistAvatar", () => {
  ...
  it("renders correctly with small size", () => {
    render(<ArtistAvatar src={mockImageSrc} size="small" />);
    const image = screen.getByTestId("artist-avatar-image");
  ...
  it("renders correctly with large size", () => {
    render(<ArtistAvatar src={mockImageSrc} size="large" />);
    const image = screen.getByTestId("artist-avatar-image");
  ...
  it("applies custom className correctly", () => {
    ...
    render(<ArtistAvatar src={mockImageSrc} className={customClass} />);
    const image = screen.getByTestId("artist-avatar-image");
  ...
  it("sets custom alt text correctly", () => {
    ...
    render(<ArtistAvatar src={mockImageSrc} alt={altText} />);
    const image = screen.getByTestId("artist-avatar-image");
