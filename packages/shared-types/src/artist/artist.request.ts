...
export const ArtistCreateSchema = z.object({
	...
	instagramAccount: z.string().max(30).describe("인스타그램 계정").default("djcool").nullable().optional(),
	youtubeAccount: z.string().max(30).describe("유튜브 계정").default("djcool").nullable().optional(),
	tiktokAccount: z.string().max(30).describe("틱톡 계정").default("djcool").nullable().optional(),
	soundcloudAccount: z.string().max(30).describe("사운드클라우드 계정").default("djcool").nullable().optional(),
	etcAccounts: z
		.array(z.string())
		.nullable()
		.describe("기타 계정들")
		...
		.optional(),
	kakaoAccount: z.string().max(30).describe("카카오 계정").default("djcool").nullable().optional(),
	lineAccount: z.string().max(30).describe("라인 계정").default("djcool").nullable().optional(),
	discordAccount: z.string().max(30).describe("디스코드 계정").default("djcool#1234").nullable().optional(),
