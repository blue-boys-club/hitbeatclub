...
export const ENUM_SETTLEMENT_TYPE = ["BANK_ACCOUNT", "PAYPAL"] as const;
export type SettlementType = (typeof ENUM_SETTLEMENT_TYPE)[number];

// cspell:disable
export const ENUM_SETTLEMENT_BANK = [
	/** 한국은행 */
	"BANK_OF_KOREA",
	/** 산업은행 */
	"KDB",
...
export type SettlementBank = (typeof ENUM_SETTLEMENT_BANK)[number];
...
export const SettlementPaypalSchema = z.object({
...
export const SettlementUpdateSchema = z.union([
	...
	SettlementPaypalSchema.partial({
		paypalAccount: true,
	}),
]);

export type SettlementCreateRequest = z.infer<typeof SettlementCreateSchema>;
export type SettlementUpdateRequest = z.infer<typeof SettlementUpdateSchema>;
