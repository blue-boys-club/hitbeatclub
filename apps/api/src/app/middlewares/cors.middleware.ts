...
export class CorsMiddleware implements NestMiddleware {
	...
	constructor(private readonly configService: ConfigService) {
		...
		this.allowOrigin = this.configService.get<string | boolean | string[]>("middleware.cors.allowOrigin");
		this.allowMethod = this.configService.get<string[]>("middleware.cors.allowMethod");
		this.allowHeader = this.configService.get<string[]>("middleware.cors.allowHeader");
	}
