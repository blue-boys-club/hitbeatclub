...
export interface IPaginationFilterDateOptions extends Omit<IPaginationFilterOptions, "isNumber"> {
	time?: ENUM_PAGINATION_FILTER_DATE_TIME_OPTIONS;
}

export interface IPaginationFilterEqualOptions extends IPaginationFilterOptions {
	isNumber?: boolean;
}
