...
describe("Dropdown", () => {
  ...
  it("works as a controlled component", () => {
    ...
    rerender(
      <Dropdown options={mockOptions} value="block" onChange={handleChange} />
    );
  ...
  it("applies custom className to the container", () => {
    ...
    render(<Dropdown options={mockOptions} className={customClass} />);
  ...
  it("applies custom optionsClassName to the options container", () => {
    ...
    render(
      <Dropdown options={mockOptions} optionsClassName={customOptionsClass} />
    );
