...
const freeDownLoadButtonVariants = cva(
	cn("font-bold leading-normal transition-colors duration-200", "rounded-full border-2 border-black cursor-pointer"),
	{
		variants: {
			variant: {
...
export const FreeDownloadButton = memo(({ variant, size, className, children, ...props }: FreeDownloadButtonProps) => {
	return (
		<button
